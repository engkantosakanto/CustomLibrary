...
#===================================================#
#              Cross Platform Keywords and Setup
#===================================================#
Get OS Type
    [Documentation]    This keyword gets the Operating System Type then assigns it to a global variable.
...
Get OS Default Download Directory
    [Documentation]    This keyword gets the default download directory e of the OS then assigns it to a global variable.
...
Delete "${p_file}" File
    [Documentation]    This keyword deletes a file if it exists.
...
Get "${p_file}" File Size
    [Documentation]    This keyword gets the file size of specified file and assign it to tc_FILE_SIZE.
...
Close "${p_applicationName}" Application
    [Documentation]    This keyword closes the application p_applicationName.
    Close Application    ${p_applicationName}

Check And Open "${p_applicationName}" Application
    [Documentation]    This keyword checks if application is running then sets it to focus, otherwise runs the application executable from the path.
...
Set Focus To "${p_applicationName}" Window
    [Documentation]    This keyword  sets the focus to the application p_applicationName's window.
    Set Application Focus    ${p_applicationName}

Switch Focus To "${p_applicationName}" Window
    [Documentation]    This keyword switches focus to the application p_applicationName's window.
    Switch Application Focus    ${p_applicationName}

Set Focus To Freelancer Desktop App
    [Documentation]    This keyword sets focus to Freelancer Desktop App, using the executable filename as parameter.
    Set Application Focus    ${${g_OS_TYPE}_FREELANCER_DESKTOP_APP_EXECUTABLE}

Close Freelancer Desktop App
    [Documentation]    This keyword closes an open instance of Freelancer Desktop App, using the executable filename as parameter.
